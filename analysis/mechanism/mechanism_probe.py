...
def p2_join_shape(self_df):
    """Own-family effect (frozen arm) joined to the measured DNA-shape axes."""
    s = (self_df[(self_df.dna == "frozen") & (self_df.selffam)]
...
def main():
    ...
    print("\n=== P2b  own-family effect vs measured shape ===")
