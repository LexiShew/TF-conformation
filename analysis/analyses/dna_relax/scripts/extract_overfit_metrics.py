...
Reads output/stage6_train/*/*/Model_metrics.json; writes analysis/analyses/dna_relax/data/training_overfit_metrics.csv.
...
pd.DataFrame(rows).to_csv(os.path.join(ROOT,"analysis/analyses/dna_relax/data/training_overfit_metrics.csv"),index=False)
