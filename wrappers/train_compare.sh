...
#SBATCH --gres=gpu:1
#SBATCH --array=0-1
#SBATCH --output=/project2/rohs_102/shewchuk/TF-conformation/slurm_output/train_%A_%a.out
#SBATCH --error=/project2/rohs_102/shewchuk/TF-conformation/slurm_output/train_%A_%a.err
...
# shellcheck source=../stage6_train/train_compare.sh
source "${TFCONF_DIR}/stage6_train/train_compare.sh"
