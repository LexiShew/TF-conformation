...
#SBATCH --output=/project2/rohs_102/shewchuk/TF-conformation/slurm_output/redock_%j.out
#SBATCH --error=/project2/rohs_102/shewchuk/TF-conformation/slurm_output/redock_%j.err
...
# shellcheck source=../stage2_redock/stage2_redock.sh
source "${TFCONF_DIR}/stage2_redock/stage2_redock.sh"
